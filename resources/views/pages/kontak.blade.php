        ...
        <div class="max-w-6xl w-full mx-auto bg-gray-800/50 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
            <div class="grid md:grid-cols-2">
                ...
                <div class="p-8 md:p-12 bg-black/20">
                    ...
                    <div id="contact-feedback-message" class="hidden rounded-lg relative mb-4 px-4 py-3" role="alert">
                    ...
                    <form id="contact-form" action="{{ route('contact.submit') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <button id="contact-submit-button" type="submit" class="w-full bg-cyan-500 text-white font-bold py-3 px-8 rounded-lg hover:bg-cyan-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-cyan-500 transition-all duration-300">
                                Kirim Pesan
                            </button>
                        </div>
                    </form>
